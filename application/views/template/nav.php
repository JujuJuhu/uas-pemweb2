...
<head>
    ...
    <meta content="SkillSphere dibuat ditujukan agar para user dan tutor dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="SkillSphere, E-learning, Open Source, Jovita Kusuma, github, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/favicon.png" type="image/png">
    <title>SkillSphere - Universitas Siber Asia</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="mailto:apps.learnify@gmail.com">apps.skillsphere@gmail.com</a>
                </div>
            </div>
        </div>
