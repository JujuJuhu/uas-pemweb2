    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang SkillSphere</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi SkillSphere</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak SkillSphere</a></li>
                        <li><a href="https://unsia.ac.id/">Website Resmi Universitas</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="#" data-toggle="modal" data-target="#exampleModalCenter">Untuk User</a></li>
                        <li><a href="<?= base_url('welcome/guru') ?>">Untuk Tutor</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="javaScript:void(0);">Course A</a></li>
                        <li><a href="javaScript:void(0);">Course B</a></li>
                        <li><a href="javaScript:void(0);">Course C</a></li>
                        <li><a href="javaScript:void(0);">Course D</a></li>
                        <li><a href="javaScript:void(0);">Course E</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>Hi, I'm a UX/UI Designer and Front End Developer.
                        With a keen eye for aesthetics and a knack for problem-solving, I specialize in creating user-friendly interfaces and bringing ideas to life through coding.</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang SkillSphere</h4>
                <p>
                    Web Edukasi Open Source yang dibuat untuk UAS PemWeb 2. SkillSphere adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. SkillSphere dibuat ditujukan agar para user dan tutor dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Learnify is made with <span class="text-danger"> &#10084;</span> by <a href="https://github.com/JujuJuhu">Kelompok 2 </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                ...
                <a href="https://www.github.com/JujuJuhu"><i class="fa fa-github"></i></a>
