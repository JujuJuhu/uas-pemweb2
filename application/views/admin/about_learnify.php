...
<head>
	...
	<title>Tentang Developer - SkillSphere</title>
	<!-- General CSS Files -->
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project SkillSphere </h1>
					</div>
					<div class="">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tentang SkillSphere</h2>
								<hr>
								<p class="card-text">SkillSphere adalah platform pembelajaran daring yang dirancang untuk membantu Anda mengembangkan keterampilan baru dan meningkatkan pengetahuan di berbagai bidang. Dengan beragam kursus yang tersedia, mulai dari teknologi, bisnis, seni, hingga keterampilan pribadi, SkillSphere memberikan akses kepada materi pembelajaran berkualitas tinggi yang dapat diakses kapan saja dan di mana saja. </p>
							</div>
						</div>
					</div>
				</section>
