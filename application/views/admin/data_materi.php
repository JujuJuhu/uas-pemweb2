...
<head>
    ...
    <title>Data Materi - SkillSphere</title>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Materi SkillSphere</h2>
                            <hr>
                            <p class="card-text"> Management Data Materi SkillSphere memastikan bahwa semua informasi pengguna disimpan dengan aman dan terorganisir.</p>
