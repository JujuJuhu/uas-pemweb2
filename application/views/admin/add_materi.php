...
<head>
    ...
    <title>Tambah Data Materi - SkillSphere </title>
    <!-- General CSS Files -->
    ...
    <div id="app">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - SkillSphere</div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard-teacher"></i>
                                <span>Tutor</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/data_guru') ?>">Data Tutor</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('admin/add_guru') ?>">Tambah Data Tutor</a>
                                </li>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Dengan menambah materi, Anda membantu menciptakan sumber daya belajar yang lebih komprehensif.
                                </p>
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label for="inputEmail4">Nama Tutor</label>
                                                    ...
                                                    <small>List guru sudah tersedia di autocomplete, kalian hanya
                                                        ...
                                                        klik Tutor yang akan dipilih.</small>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small>Jika nama course sudah berganti artinya nama Tutor yang kamu
                                                    masukan di input area adalah valid! jika tidak muncul nama course
                                                    anda harus klik input area nama tutor dan pilih guru yang tersedia
                                                    disana.</small>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required id="inputState" name="kelas" class="form-control">
                                                    ...
                                                    <option value="X"> Basic </option>
                                                    <option value="XI"> Intermediate </option>
                                                    <option value="XII"> Advanced </option>
                                                </select>
                                            </div>
        ...
        <footer class="main-footer">
            <div class="text-center">
                Copyright &copy; 2020 <div class="bullet"></div><a href="https://github.com/JujuJuhu">Kelompok 2</a>
            </div>
        </footer>
        <!-- End Footer -->
