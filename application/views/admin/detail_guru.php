...
<head>
    ...
    <title>Data Detail Tutor - SkillSphere </title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Detail Tutor | <?= $detail->nama_guru ?> </h2>
                            <hr>
                            <p class="card-text">Pastikan semua detail tutor diisi dengan lengkap dan akurat untuk pengalaman yang optimal.
                            </p>
                    ...
                    <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                        ...
                        <table style="width: 100%" class="container text-center">
                            <tbody>
                                ...
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Nama Tutor :</span></td>
