...
<head>
    ...
    <title>Tambah Data Tutor - SkillSphere</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Data Tutor</h2>
                                <hr>
                                <p class="card-text"> Management Data Tutor di SkillSphere membantu menyediakan layanan yang lebih personal dan disesuaikan.
                                </p>
